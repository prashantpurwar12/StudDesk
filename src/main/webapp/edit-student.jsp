<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@ page import="com.studdesk.model.Student" %>
        ...
        <head>
            ...
            <title>Edit Student - EduDesk</title>
        ...
        <body>
            <div class="container">
                                    ...
                                    <% Student student=(Student) request.getAttribute("student"); %>
                                        ...
                                        <% if (student !=null) { %>
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="tel" id="phone" name="phone"
                                                            value="<%= student.getPhone() %>" placeholder="10 digits"
                                            ...
                                            <% } else { %>
                                                ...
                                                <a href="student?action=list" class="btn btn-primary">
                ...
                <footer class="footer">
                    <p>&copy; 2025 EduDesk. Built with <i class="fas fa-heart" style="color: #ef4444;"></i> using Java &
                        JSP</p>
                </footer>
            </div>
